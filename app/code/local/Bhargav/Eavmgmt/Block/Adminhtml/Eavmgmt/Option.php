...
class Bhargav_Eavmgmt_Block_Adminhtml_eavmgmt_Option extends Mage_Adminhtml_Block_Widget_Grid
{
   ...
   protected function _prepareCollection()
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('value', array(
            ...
            'index' => 'value',
            'renderer' => 'Bhargav_Eavmgmt_Block_Adminhtml_eavmgmt_Option_Renderer_Option'
        ));
