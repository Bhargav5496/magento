<?php
class Bhargav_Bhargav_Model_Resource_Attribute_Collection
    extends Mage_Eav_Model_Resource_Entity_Attribute_Collection
{
    ...
    {
        $entityTypeId = (int)Mage::getModel('eav/entity')->setType(Bhargav_Bhargav_Model_Bhargav::ENTITY)->getTypeId();
