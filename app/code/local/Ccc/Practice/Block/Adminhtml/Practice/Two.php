...
class Ccc_Practice_Block_Adminhtml_Practice_Two extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        //     ->joinLeft(
        //         array('ao' => $attributeCollection->getTable('eav/attribute_option')),
        //         'main_table.attribute_id = ao.attribute_id',
        //         array('option_id')
        //     )
        //     ->joinLeft(
        //         array('aov' => $attributeCollection->getTable('eav/attribute_option_value')),
        ...
        // $result = $attributeCollection->getData();
