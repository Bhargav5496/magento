...
class Ccc_Practice_Block_Adminhtml_Practice_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        'label' => Mage::helper('practice')->__('Practice Address Information'),
        'title' => Mage::helper('practice')->__('Practice Address Information'),
        'content' => $this->getLayout()->createBlock('practice/adminhtml_vendor_edit_tab_address')->toHtml(),
        ));
